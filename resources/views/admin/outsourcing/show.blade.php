...
@section('title', 'Detail Outsourcing')
@section('page-title', 'Detail Tenaga Outsourcing')
        ...
        <div class="card-custom h-100">
            <div class="card-body text-center p-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.outsourcing.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="col-lg-8">
        <div class="card-custom mb-4">
            <div class="card-header">
                <span><i class="bi bi-info-circle-fill me-2"></i> Informasi Detail Pekerjaan</span>
            </div>
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-sm-6 border-bottom pb-3">
                        <div class="text-muted small mb-1">Perusahaan Vendor</div>
                        <div class="fw-bold fs-6">{{ $outsourcing->outsourcingEmployee->company_name ?? '-' }}</div>
                    </div>
                    <div class="col-sm-6 border-bottom pb-3">
                        <div class="text-muted small mb-1">Jabatan / Tugas</div>
                        <div class="fw-bold fs-6">{{ $outsourcing->outsourcingEmployee->position ?? '-' }}</div>
                    </div>
                    <div class="col-sm-4 border-bottom pb-3">
                        <div class="text-muted small mb-1">Masa Kontrak</div>
                        <div class="fw-bold">
                    ...
                    <div class="col-sm-4 border-bottom pb-3">
                        <div class="text-muted small mb-1">Nomor Kontrak</div>
                        <div class="fw-bold">{{ $outsourcing->outsourcingEmployee->contract_number ?? '-' }}</div>
                    </div>
                    <div class="col-sm-4 border-bottom pb-3">
                        <div class="text-muted small mb-1">Nomor Telepon</div>
                        <div class="fw-bold">{{ $outsourcing->phone ?? '-' }}</div>
                    </div>
                    <div class="col-12">
                        <div class="text-muted small mb-1">Alamat Domisili</div>
                        <div class="fw-bold">{{ $outsourcing->address ?? '-' }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-custom">
            <div class="card-header">
                ...
                <a href="{{ route('admin.attendance.index', ['user_id' => $outsourcing->id]) }}" class="btn btn-sm btn-outline-custom">Lihat Semua Absensi</a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-custom mb-0">
                        ...
                        <tbody>
                            @forelse($outsourcing->attendances->take(5) as $att)
                            <tr>
